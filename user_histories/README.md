...
Historias de usuario del challenge "Inventory Reservation System", escritas en Gherkin en español.
...
- Las historias deben guiar los artefactos SDD posteriores: `spec.md`, `plans.md`/`plans/`, `tasks.md`/`tasks/` y contrato OpenAPI.
