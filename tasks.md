...
- [ ] T-003 Crear estructura de carpetas del proyecto.
  ...
  - Referencias: `plan.md#entrega`.

- [ ] T-004 Crear `docker-compose.yml` para PostgreSQL local.
  - Owner: `docker-compose.yml`.
  - Referencias: `plan.md#entrega`, `skills/delivery-artifacts/SKILL.md`.
...
- [ ] T-005 Crear migración inicial PostgreSQL.
  ...
  - Referencias: `specs/001-inventory-reservation-system/domain-model.md`, `plan.md#estrategia-de-idempotencia`.
...
- [ ] T-007 Inicializar módulo Go backend.
  ...
  - Referencias: `plan.md#backend`, `skills/backend-reservation-system/SKILL.md`.
...
- [ ] T-010 Implementar creación de reserva atómica.
  ...
  - Referencias: `user_histories/02_atomic_reservations.feature`, `plan.md#estrategia-de-concurrencia`.
...
- [ ] T-011 Implementar idempotencia para `POST /reservations`.
  ...
  - Referencias: `user_histories/05_idempotency.feature`, `plan.md#estrategia-de-idempotencia`.
...
- [ ] T-013 Implementar release idempotente.
  ...
  - Referencias: `user_histories/04_manual_release.feature`, `plan.md#estrategia-de-ttl-y-release`.
...
- [ ] T-014 Implementar expiración lazy de reservas.
  ...
  - Referencias: `user_histories/03_reservation_ttl.feature`, `plan.md#estrategia-de-ttl-y-release`.
...
- [ ] T-021 Inicializar frontend React + Vite + TypeScript.
  - Owner: `frontend/`.
  - Referencias: `plan.md#frontend`, `skills/frontend-reservation-app/SKILL.md`.
...
- [ ] T-026 Implementar timer de expiración y reconciliación.
  ...
  - Referencias: `user_histories/03_reservation_ttl.feature`, `plan.md#estado-frontend`.
...
- [ ] T-031 Crear `README.md`.
  - Owner: `README.md`.
  - Referencias: `skills/delivery-artifacts/SKILL.md`, `plan.md#entrega`.
