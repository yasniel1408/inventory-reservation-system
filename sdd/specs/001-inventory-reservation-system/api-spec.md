...
- Los requests se asocian al usuario/session actual. Para el challenge es aceptable una session anónima sembrada o header simple si queda documentado en el plan activo enlazado desde `sdd/plans.md`.
